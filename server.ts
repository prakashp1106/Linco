...
app.post("/api/config", (req, res) => {
  // Security Check: Enforce ADMIN_API_KEY authentication if configured
  if (!validateAdminApiKey(process.env.ADMIN_API_KEY, req.headers["x-admin-key"], req.body?.adminKey)) {
