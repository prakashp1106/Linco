...
export const allTranslations: Record<LanguageCode, Record<string, string>> = {
  en: { ...enTranslations, ...(extraTranslations.en || {}) },
  hi: { ...hiTranslations, ...(extraTranslations.hi || {}) },
  mr: { ...mrTranslations, ...(extraTranslations.mr || {}) },
  gu: { ...guTranslations, ...(extraTranslations.gu || {}) },
  bn: { ...bnTranslations, ...(extraTranslations.bn || {}) },
  ta: { ...taTranslations, ...(extraTranslations.ta || {}) },
  te: { ...teTranslations, ...(extraTranslations.te || {}) },
  kn: { ...knTranslations, ...(extraTranslations.kn || {}) },
  ml: { ...mlTranslations, ...(extraTranslations.ml || {}) },
  pa: { ...paTranslations, ...(extraTranslations.pa || {}) },
  or: { ...orTranslations, ...(extraTranslations.or || {}) },
  as: { ...asTranslations, ...(extraTranslations.as || {}) },
  ur: { ...urTranslations, ...(extraTranslations.ur || {}) },
  sa: { ...saTranslations, ...(extraTranslations.sa || {}) },
  ne: { ...neTranslations, ...(extraTranslations.ne || {}) },
  kok: { ...kokTranslations, ...(extraTranslations.kok || {}) },
  mai: { ...maiTranslations, ...(extraTranslations.mai || {}) },
  ks: { ...ksTranslations, ...(extraTranslations.ks || {}) },
  doi: { ...doiTranslations, ...(extraTranslations.doi || {}) },
  brx: { ...brxTranslations, ...(extraTranslations.brx || {}) },
  mni: { ...mniTranslations, ...(extraTranslations.mni || {}) },
  sat: { ...satTranslations, ...(extraTranslations.sat || {}) },
  sd: { ...sdTranslations, ...(extraTranslations.sd || {}) },
  es: { ...esTranslations, ...(extraTranslations.es || {}) },
  fr: { ...frTranslations, ...(extraTranslations.fr || {}) },
  de: { ...deTranslations, ...(extraTranslations.de || {}) },
  pt: { ...ptTranslations, ...(extraTranslations.pt || {}) },
  it: { ...itTranslations, ...(extraTranslations.it || {}) },
  ar: { ...arTranslations, ...(extraTranslations.ar || {}) },
  zh: { ...zhTranslations, ...(extraTranslations.zh || {}) },
  ja: { ...jaTranslations, ...(extraTranslations.ja || {}) },
  ko: { ...koTranslations, ...(extraTranslations.ko || {}) },
  id: { ...idTranslations, ...(extraTranslations.id || {}) },
  nl: { ...nlTranslations, ...(extraTranslations.nl || {}) },
  ru: { ...ruTranslations, ...(extraTranslations.ru || {}) },
  tr: { ...trTranslations, ...(extraTranslations.tr || {}) },
  vi: { ...viTranslations, ...(extraTranslations.vi || {}) },
  th: { ...thTranslations, ...(extraTranslations.th || {}) },
};
