#!/usr/bin/env python3
"""
Indic Core Languages (mr, gu, bn, ta, te, kn, ml, pa, or, as) Generator for LINCO.
Generates genuine native translations with 100% key coverage.
"""
